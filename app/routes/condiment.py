...
def create_condiment(condiment_data: CondimentCreate, db: Session = Depends(get_session)):
...
def list_condiments(restaurant_id: UUID, db: Session = Depends(get_session)):
