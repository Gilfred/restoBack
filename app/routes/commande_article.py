...
def read_commande_article(article_id: UUID, db: Session = Depends(get_session)):
...
def update_commande_article(article_id: UUID, article_data: CommandeArticleUpdate, db: Session = Depends(get_session)):
...
def delete_commande_article(article_id: UUID, db: Session = Depends(get_session)):
